...
#瀹氭椂浠诲姟鍖椾含鎵ц鏃堕棿(0~23)
BEIJING_UPDATE_TIME=3

#璁板綍鏈€寮€濮嬭繍琛岃剼鏈殑璺緞
BEGIN_PATH=$(pwd)

#瀹夎鏂瑰紡, 0涓哄叏鏂板畨瑁? 1涓轰繚鐣檝2ray閰嶇疆鏇存柊
INSTALL_WAY=0
...
EOF
    ...
    #绉婚櫎鏃х殑v2ray bash_completion鑴氭湰
    ...
    #瀹夎V2ray涓荤▼搴?    [[ ${INSTALL_WAY} == 0 ]] && bash <(curl -L -s https://multi.netlify.app/go.sh)
}
